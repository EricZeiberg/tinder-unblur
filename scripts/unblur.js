...
const THUMBNAIL_IMAGE_URL_REGEX = /https:\/{2}preview.gotinder.com\/\w{8}-(\w{4}-){3}\w{12}\/\d{3}x\d{3}_\w{8}-(\w{4}-){3}\w{12}.jpg/
...
const TINDER_GOLD_ADVERTISMENT_DIALOG_CLASS_NAME = "Bdrs(8px) Ov(h) Ta(c) Bgc(#fff) My(10px) Mx(a) Py(36px) Px(44px) Py(12px)--s Px(20px)--s W(100%) Miw(300px) W(400px)--ml P(0)! Mah(100%)--xs Ovy(s)--xs Ovs(touch)--xs Ovsby(n)--xs";
